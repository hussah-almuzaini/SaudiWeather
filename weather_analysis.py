...
with filter_cols[0]:
    st.markdown("<h5 style='color:#5d9c7d;'>🗺️ Select Map Type</h5>", unsafe_allow_html=True)
...
with filter_cols[1]:
    st.markdown("<h5 style='color:#5d9c7d;'>📅 Start Date</h5>", unsafe_allow_html=True)
    start_date = st.date_input("", value=min_date, min_value=min_date, max_value=max_date)

with filter_cols[2]:
    st.markdown("<h5 style='color:#5d9c7d;'>📅 End Date</h5>", unsafe_allow_html=True)
